...
{
	/**
	 * In the case of an application, the alias is passed to @See
	 * org.osgi.service.http.HttpService#registerServlet(String alias, Servlet servlet, Dictionary
	 * initparams, HttpContext context) when the servlet is registered. Any resources that are to be
